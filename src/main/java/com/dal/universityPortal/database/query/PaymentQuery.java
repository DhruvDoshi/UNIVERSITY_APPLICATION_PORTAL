...
public class PaymentQuery {
    ...
    public static final String FETCH_STATUS_APPLICATION_ID = "SELECT status from application where application_id = ?";
    public static final String UPDATE_STATUS_APPLICATION_ID = "UPDATE application SET status = 'PAID' WHERE application_id = ?";
